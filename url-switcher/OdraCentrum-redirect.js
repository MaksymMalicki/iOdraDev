...
document.getElementsByClassName('facebook')[0].removeAttribute("href");
document.getElementsByClassName('instagram')[0].removeAttribute("href");
document.getElementsByClassName('email')[0].removeAttribute("href");
